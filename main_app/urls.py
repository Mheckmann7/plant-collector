...
urlpatterns = [
    ...
    path('problems/<int:pk>/update/',
         views.ProblemUpdate.as_view(), name='problems_update'),
    path('problems/<int:pk>/delete/',
         views.ProblemDelete.as_view(), name='problems_delete'),
    path('plants/<int:plant_id>/assoc_problem/<int:problem_id>/',
         views.assoc_problem, name='assoc_problem'),
